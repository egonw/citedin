...
<?php
   ...
   if (isset($_GET["pubmed_query"])){
	...
	print "<hr>";
    if ($_SERVER["SCRIPT_FILENAME"]=="fragment_1.php")	print "<a href=\"loadBiblioDataMetrics.php?pmids=".implode(",", $pmids)."\" target=\"_blank\">calculate CitedIn Internet Citation Score</a><hr>";
