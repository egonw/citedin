...
<P style=\"TEXT-ALIGN: right\"><SPAN style=\"FONT-SIZE: x-small\">Examples: Pubmed query: (e.g. 
	...
	<center><form id=\"queryForm\"><input name=\"pmidQuery\" id=\"pmidQuery\" type=\"text\" size=\"75\"/><select id=\"queryoptions\"><option>Pubmed Query</option><option>PMID</option></select><br><button type=\"submit\" id=\"citedinQuery\" value=\"Go...\" /></form></center>";
